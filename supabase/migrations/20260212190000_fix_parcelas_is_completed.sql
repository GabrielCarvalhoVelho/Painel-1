-- Migration: Adiciona is_completed = true nas parcelas criadas pela função
-- Data: 2026-02-12
-- Problema: Parcelas criadas não apareciam porque is_completed era NULL
...
-- Corrigir as parcelas que já foram criadas sem is_completed
UPDATE transacoes_financeiras
SET is_completed = true, ativo = true
