    ...
    <div className="block md:hidden px-4 space-y-3">
      {maquinas.map((maquina) => (
        <div
          ...
          className="bg-white rounded-xl shadow-[0_2px_8px_rgba(0,68,23,0.04)] border border-[rgba(0,68,23,0.08)] p-4 active:bg-[rgba(0,166,81,0.05)] transition-all"
        >
          <div className="flex items-start justify-between mb-3">
            ...
            <button
              ...
              className="p-2 text-[#004417] active:text-[#00A651] active:bg-[rgba(0,166,81,0.08)] rounded-lg transition-colors"
            >
